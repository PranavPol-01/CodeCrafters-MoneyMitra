  ...
  return (
    <div className="container mx-auto py-6">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6">
        <div>
          ...
          <p className="text-muted-foreground">
            Learn investment strategies with virtual money in a risk-free environment
          </p>
        </div>
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4 mb-6">
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">
              <span className="text-emerald-500 font-medium">↑ 24.5%</span> from starting amount
            </p>
          </CardContent>
        </Card>
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold text-emerald-500">+$2,450.75</div>
            <p className="text-xs text-muted-foreground">Since simulation started</p>
          </CardContent>
        </Card>
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">Simulation Rank</CardTitle>
            <Lightbulb className="h-4 w-4 text-muted-foreground" />
          </CardHeader>
          <CardContent>
            <div className="text-2xl font-bold">#42</div>
            <p className="text-xs text-muted-foreground">Out of 1,245 participants</p>
          </CardContent>
        </Card>
      </div>
